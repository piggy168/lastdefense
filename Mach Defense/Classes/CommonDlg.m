...
- (id)initWithCommonImg:(NSString *)commonImg TopImg:(NSString *)topImg Height:(float)height
{
    ...
    NSString *strBorder = @"Dlg_Screen_Border.png";
    
    if (topImg == @"half") strBorder = @"Dlg_Screen_Border_half.png";

    Tile2D *tile = [TILEMGR getTileForRetina:strBorder];
	_bgMid = [[QobImage alloc] initWithTile:tile tileNo:0];
    [_bgMid setPosX:15.0f Y:-80.0f];
